...
export function AppLayout({ children }: AppLayoutProps) {
  ...
  return (
    <div className="flex h-screen w-full bg-[#F8FAFC] dark:bg-slate-950 overflow-hidden">
      ...
      {/* Main Content Area */}
      <div className={cn(
        "flex-1 flex flex-col min-w-0 bg-white dark:bg-slate-900 overflow-hidden transition-all duration-300",
        !isMobile ? "rounded-tl-[1.5rem] shadow-glass mt-2 border-l border-t border-slate-100 dark:border-slate-800" : "mt-0"
      )}>
        {/* Top Header */}
